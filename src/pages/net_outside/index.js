            ...
            <div className="net_outside">
                ...
                <div className="input-group">
                    ...
                    <div className="types">
                        ...
                        <a href="javascript:void(0)" onClick={()=>this.chooseType('pppoe')} className={protox=='pppoe'?'active':''} ><input readOnly checked={protox=='pppoe'?true:false} type="checkbox"/>宽带账号(PPPOE)</a>
                        <a href="javascript:void(0)" onClick={()=>this.chooseType('static')} className={protox=='static'?'active':''} ><input readOnly checked={protox=='static'?true:false} type="checkbox"/>静态地址</a>
                    </div>
                </div>
                {
